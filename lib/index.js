...
require("jsgi-node").start(
	...
	// cascade from static to pintura REST handling
		...
		require("pintura/jsgi/static").Static({urls:["explorer"],roots:[require("nodules").getCachePath("persevere/")]}),
		require("pintura/jsgi/static").Static({urls:["js/persevere"],roots:[require("nodules").getCachePath("persevere/")]}),
