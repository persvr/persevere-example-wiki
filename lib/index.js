		...
		require("jsgi-node").Listener(
			...
			//require("pintura/jsgi/compress").Compress(
				...
				// cascade from static to pintura REST handling
					...
					Static({urls:["/explorer"],roots:[require("nodules").getCachePath("persevere-client/")]}),
					Static({urls:["/js/dojo-persevere"],roots:[require("nodules").getCachePath("persevere-client/")]}),
